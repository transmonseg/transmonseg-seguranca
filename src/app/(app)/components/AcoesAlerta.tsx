  ...
  return (
    <div className="mt-4 pt-3.5" style={{ borderTop: "1px solid var(--border-subtle)" }}>
      ...
      <div className="flex items-center gap-2 flex-wrap">
        ...
        <Btn onClick={() => exec(resolverAlerta)} pending={pending} cor="var(--verde)" titulo="Encerrar: tratado">
          <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
            <polyline points="20 6 9 17 4 12" />
          </svg>
          Resolver
        </Btn>
        <Btn onClick={() => exec(marcarFalsoPositivo)} pending={pending} cor="var(--text-muted)" titulo="Engano: silencia o tipo por 2h e ensina o sistema">
          <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
